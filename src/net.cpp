...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Tomatocoin " + FormatFullVersion();
...
{
    {
        ...
        vAddedNodes.push_back("115.28.55.77");
        vAddedNodes.push_back("210.209.125.41");
        vAddedNodes.push_back("192.126.123.153");
        vAddedNodes.push_back("115.29.12.38");
        vAddedNodes.push_back("107.182.185.56");
        vAddedNodes.push_back("122.234.234.131");
        vAddedNodes.push_back("tomatocoin.xicp.net:9888");
        vAddedNodes.push_back("huolongyema.eicp.net:9888");
        vAddedNodes.push_back("tommyyes.vicp.cc:9888");
        vAddedNodes.push_back("tomatocoin.wicp.net:9888");
        vAddedNodes.push_back("tomatocoin.vicp.net:9888");
        vAddedNodes.push_back("tomatocoin02.eicp.net:9888");
        vAddedNodes.push_back("www.hualihuawai.com");
        vAddedNodes.push_back("xhome.wicp.net:9888");
        vAddedNodes.push_back("tomatocoin01.vicp.cc:9888");
        vAddedNodes.push_back("104.128.83.188:9888");
    }
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Tomatocoin is probably already running."), addrBind.ToString().c_str());
        else
